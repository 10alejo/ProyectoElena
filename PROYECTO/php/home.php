            ...
            <div class="hero-left">
                ...
                <div class="white-timer-box slider-container">
                    ...
                    <div class="mySlides fade">
                        ...
                        <button class="btn-subscribe" onclick="location.href='../php/suscripciones.php'">SUSCRÍBETE
                            AHORA</button>
                    </div>
    ...
    <section class="gym-detail-section">
        <div class="gym-detail-container">
            <div class="gym-info-side">
                ...
                <div class="gym-data">
                    <p class="data-item">📍 <a
                            href="https://www.google.com/maps/search/?api=1&query=Calle+Via+Limite+14+28029+Madrid">
                            Calle Vía Límite 14</a></p>
                ...
                <button class="btn-subscribe-purple" onclick="location.href='../php/reservas.php'">RESERVA TUS
                    CLASES</button>
            </div>
        ...
        <div class="founders-grid">
            <div class="photo-card">
                ...
                <div class="preview">
                    ...
                    <button onclick="location.href='../php/perfil.php?user=diego'">Ver perfil</button>
                </div>
            </div>
            <div class="photo-card">
                ...
                <div class="preview">
                    ...
                    <button onclick="location.href='../php/perfil.php?user=alejandro'">Ver perfil</button>
                </div>
            </div>
            <div class="photo-card">
                ...
                <div class="preview">
                    ...
                    <button onclick="location.href='../php/perfil.php?user=ivan'">Ver perfil</button>
                </div>
            </div>
            <div class="photo-card">
                ...
                <div class="preview">
                    ...
                    <button onclick="location.href='../php/perfil.php?user=adrian'">Ver perfil</button>
                </div>
            </div>
        </div>
    </section>
