<?php
// 1. Cargamos la lógica de tiempo ANTES de cualquier HTML
require_once 'tiempo.php'; 

// Ya no hace falta session_start() aquí porque ya está dentro de tiempo.php
...
<body>
    ...
    <section class="founders-section">
        ...
        <p class="founders-text">AllGim nace de nuestra pasión compartida por el entrenamiento de fuerza y la superación personal...</p>

        <div class="founders-grid">
            <div class="photo-card">
                <div class="photo-name">Diego</div>
                <div class="photo-img"><img src="../php/mostrar_foto.php?nombre=diego" alt="Diego" /></div>
                <div class="preview">
                    <h3>Diego</h3>
                    <p><strong>Edad:</strong> 19 años</p>
                    <p><strong>Peso:</strong> 66 Kg</p>
                    <button onclick="location.href='../php/perfil.php?user=diego'">
                        <?= ($usuario_logueado && strtolower($usuario_logueado) === 'diego') ? 'Ver perfil' : 'Previsualizar' ?>
                    </button>
                </div>
            </div>
            ...
            <div class="photo-card">
                ...
                <div class="photo-img"><img src="../php/mostrar_foto.php?nombre=alejandro" alt="Alejandro" /></div>
                <div class="preview">
                    <h3>Alejandro</h3>
                    <p><strong>Edad:</strong> 19 años</p>
                    <p><strong>Peso:</strong> 72 Kg</p>
                    <button onclick="location.href='../php/perfil.php?user=alejandro'">
                        <?= ($usuario_logueado && strtolower($usuario_logueado) === 'alejandro') ? 'Ver perfil' : 'Previsualizar' ?>
                    </button>
                </div>
            </div>
            ...
            <div class="photo-card">
                ...
                <div class="photo-img"><img src="../php/mostrar_foto.php?nombre=ivan" alt="Ivan" /></div>
                <div class="preview">
                    <h3>Iván</h3>
                    <p><strong>Edad:</strong> 19 años</p>
                    <p><strong>Peso:</strong> 68 Kg</p>
                    <button onclick="location.href='../php/perfil.php?user=ivan'">
                        <?= ($usuario_logueado && strtolower($usuario_logueado) === 'ivan') ? 'Ver perfil' : 'Previsualizar' ?>
                    </button>
                </div>
            </div>
            ...
            <div class="photo-card">
                ...
                <div class="photo-img"><img src="../php/mostrar_foto.php?nombre=adrian" alt="Adrian" /></div>
                <div class="preview">
                    <h3>Adrián</h3>
                    <p><strong>Edad:</strong> 21 años</p>
                    <p><strong>Peso:</strong> 97 Kg</p>
                    <button onclick="location.href='../php/perfil.php?user=adrian'">
                        <?= ($usuario_logueado && strtolower($usuario_logueado) === 'adrian') ? 'Ver perfil' : 'Previsualizar' ?>
                    </button>
                </div>
            </div>
        </div>
    ...
    <footer class="footer">
        ...
        <a href="subir_todo.php">Subir imagenes a base de datos</a>
    </footer>
