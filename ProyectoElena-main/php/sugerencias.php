...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombre) && !empty($mensaje) && !empty($categoria)) {
        try {
            ...
            if ($resultado) { header("Location: " . $_SERVER['PHP_SELF']); exit; }
        } catch (PDOException $e) { $mensaje_status = "Error al guardar."; }
    }
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="list-title">SUGERENCIAS RECIENTES</h2>
        <div class="suggestions-container">
            <?php /* Bucle de sugerencias aquí */ ?>
        </div>
    </div>
</body>
</html>