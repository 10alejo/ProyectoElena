...
<head>
    ...
    <style>
    /* Estilos para el Dropdown de Usuario (Versión 1) */
    .user-dropdown {
        position: relative;
    ...
    /* Ajuste para el icono de usuario genérico */
    .user-link-icon {
        font-size: 1.5rem;
        text-decoration: none;
        color: white;
    ...
    <section class="gym-detail-section">
        <div class="gym-detail-container">
            <div class="gym-info-side">
                ...
                <div class="gym-data">
                    <p class="data-item">📍 <a href="#" target="_blank">Calle Juan Mieg 12</a></p>
                    <p class="data-item">🕒 Lu– Vi: 6:00h – 00:00h<br>Sa, do y festivos: 08:00h - 21:00h</p>
                </div>
                <hr class="divider">
            ...
            <div class="gym-video-side">
                <div class="video-wrapper">
                    <video controls poster="../images/poster-gym.jpg">
                        <source src="../videos/video-ia.mp4" type="video/mp4">
