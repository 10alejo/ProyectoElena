        ...
        <div class="hero-container">
            <div class="hero-left">
                ...
                <div class="white-timer-box">
                    ...
                    <button class="btn-subscribe" onclick="location.href='../pages/suscripciones.html'">SUSCRÍBETE AHORA</button>
                </div>
            </div>
    ...
    <section class="gym-detail-section">
        <div class="gym-detail-container">
            <div class="gym-info-side">
                ...
                <div class="gym-data">
                    <p class="data-item">📍 <a href="https://www.google.com/maps/search/?api=1&query=Calle+Juan+Mieg+12+28054+Madrid">Calle Juan Mieg 12</a></p>
                ...
                <button class="btn-subscribe-purple" onclick="location.href='../pages/suscripciones.html'">SUSCRÍBETE AHORA</button>
            </div>
