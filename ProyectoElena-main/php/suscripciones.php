...
<html lang="es">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700;900&family=Quicksand:wght@700&display=swap" rel="stylesheet"/>
    ...
    <main class="pricing-container">
      ...
      <div class="pricing-grid">
        <div class="price-card">
          ...
          <button
            class="btn-plan"
            onclick="window.location.href='../php/checkout.php?plan=basico'"
          >
        ...
        <div class="price-card featured">
          ...
          <button
            class="btn-plan orange"
            onclick="window.location.href='../php/checkout.php?plan=avanzado'"
          >
        ...
        <div class="price-card highlight">
          ...
          <button
            class="btn-plan yellow"
            onclick="window.location.href='../php/checkout.php?plan=ultimate'"
          >
