...
// 1. LÓGICA DE FECHAS
// ---------------------------------------------------------
// Recibimos fecha por URL o usamos hoy
$fecha_actual_str = isset($_GET['fecha']) ? $_GET['fecha'] : date('Y-m-d');
$timestamp_actual = time(); // Momento exacto actual

// Crear objeto DateTime para manipular días
$fecha_obj = new DateTime($fecha_actual_str);

// Formatear fecha para el título (Ej: Jueves, 29 de Enero)
// strftime está obsoleto en PHP 8.1+, usamos IntlDateFormatter si es posible, o un array simple para seguridad
...
// ---------------------------------------------------------
// 2. DATOS DE EJEMPLO (SIMULACIÓN BD)
// ---------------------------------------------------------
$actividades = [
    [
        "nombre" => "Body Pump",
            ...
            <div class="date-navigation">
                ...
                <div class="current-date-group">
                    ...
                    <form action="" method="GET" class="form-calendario">
                        ...
                        <input type="date" id="date-input" name="fecha" value="<?= $fecha_actual_str ?>" onchange="this.form.submit()">
                    </form>
                </div>
                ...
                <div class="card-actividad <?= ($estado_btn != 'activo') ? 'deshabilitada' : '' ?>">
                    ...
                    <div class="card-footer">
                        <?php if ($estado_btn == 'activo'): ?>
                            <button class="btn-reservar" onclick="confirmarReserva('<?= $clase['nombre'] ?>', '<?= $clase['hora_inicio'] ?> del <?= $fecha_actual_str ?>')">
                                <?= $texto_btn ?>
                            </button>
                        <?php else: ?>
