...
if (isset($_POST['accion']) && $_POST['accion'] == 'registrar') {
    ...
    if ($resultado) {
        ...
        $mensaje_registro = "<p style='color:red;'>Error: El nombre ya existe.</p>";
...
if (isset($_POST['accion']) && $_POST['accion'] == 'login') {
    ...
    if ($usuarioDatos && password_verify($password, $usuarioDatos['password'])) {
        ...
        $mensaje_login = "<p style='color:red;'>Usuario o contraseña incorrectos.</p>";
...
<head>
    ...
    <style>
    /* Clase auxiliar para ocultar lo que no toque ver */
    .oculto {
        display: none;
    }
    ...
    <div class="container">
        ...
        <div class="form-box <?= ($vista_actual == 'login') ? 'active' : '' ?>">
            ...
            <form method="POST">
                ...
                <p style="text-align: center; margin-top: 15px;">
                    ...
                    <a href="acceso.php?v=registro" style="color: #70b935; font-weight: bold;">Regístrate aquí</a>
                </p>
            </form>
        </div>
        ...
        <div class="form-box <?= ($vista_actual == 'registro') ? 'active' : '' ?>">
            ...
            <form method="POST">
                ...
                <p style="text-align: center; margin-top: 15px;">
                    ¿Ya tienes cuenta?
                    <a href="acceso.php?v=login" style="color: #70b935; font-weight: bold;">Inicia sesión</a>
                </p>
            </form>
        </div>
