...
if (isset($_POST['accion']) && $_POST['accion'] == 'registrar') {
    ...
    if (empty($nombre)) {
        ...
        $mensaje_registro = "<p style='color:blue;'>El nombre de Usuario no puede estar vacío.</p>";
        $vista_actual = 'registro';
    }

    else if (strpos($nombre, ' ') !== false) {

        $mensaje_registro = "<p style='color:blue;'>El nombre de Usuario no puede contener espacios en blanco.</p>";
        $vista_actual = 'registro';
    }

    else if (strlen($password) < 8) {

        $mensaje_registro = "<p style='color:blue;'>La contraseña debe de contener almenos 8 carácteres.</p>";
        $vista_actual = 'registro';
    }
    ...
    if ($resultado) {
        ...
        $mensaje_registro = "<p style='color:blue;'>El usuario ya existe.</p>";
...
if (isset($_POST['accion']) && $_POST['accion'] == 'login') {
    ...
    if ($usuarioDatos && password_verify($password, $usuarioDatos['password'])) {
        ...
        $mensaje_login = "<p style='color:blue;'>Usuario o contraseña incorrectos.</p>";
    ...
    <div class="container">
        ...
        <div class="form-box <?= ($vista_actual == 'login') ? 'active' : '' ?>">
            ...
            <form method="POST">
                ...
                <input type="text" name="nombre_login" placeholder="Nombre de Usuario"  autofocus required pattern="^\S+$" title="No se permiten espacios en blanco">
        ...
        <div class="form-box <?= ($vista_actual == 'registro') ? 'active' : '' ?>">
            ...
            <form method="POST">
                ...
                <input type="text" name="nombre_reg" placeholder="Nombre" required pattern="^\S+$" title="No se permiten espacios en blanco">
